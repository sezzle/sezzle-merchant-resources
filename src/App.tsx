      ...
      <div className="terms">
        <p>
          ...
          {countryCodeRef.current === "CA" ? (
             <div className="CAterms"><span id="term3">{translation.term1}</span><span id="term3">{translation.term3}</span></div>
          ) : (
             <div className="USterms"><span id="term2">{translation.term2}</span></div>
          )}
        </p>
        <p>
          <sup>2</sup>
