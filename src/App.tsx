...
const onFailure = (error: Error, info: ErrorInfo) => {
    ...
    dispatchEvent(config, ABOUT_SEZZLE_ERROR_EVENT, info.componentStack || "");
};
        ...
        >
            ...
            >
                <div
                    ...
                    aria-label={translation.logoAltText}
                >
                    <Logo />
                </div>
                ...
                <div className="card-area">
                    ...
                    <div className="info-card">
                        ...
                        <p className="sezzle-info">
                            {translation.checkoutInfo}
                        </p>
                    </div>
                    <div className="info-card">
                        ...
                        <p
                            ...
                            dangerouslySetInnerHTML={{
                                __html: translation.shipmentInfo,
                            }}
                        ></p>
                    </div>
                </div>
